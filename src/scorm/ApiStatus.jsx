...
class ApiStatus extends Component {
    ...
    onScoreChange(e) {
        ...
        score[field] =
            field === "status" ? e.target.value : Number(e.target.value);
        this.setState({
            score,
        });
    }
    ...
    render() {
        ...
        return (
            <section className="section">
                ...
                <button className="button" onClick={() => setStatus("passed")}>
                    passed
                </button>
                <button
                    className="button"
                ...
                <button className="button" onClick={() => setStatus("failed")}>
                    failed
                </button>
                <button
                    className="button"
                ...
                <button className="button" onClick={() => setStatus("browsed")}>
                    browsed
                </button>
                <button
                    className="button"
                    onClick={() => setStatus("not attempted")}
                >
                    not attempted
                </button>
                <hr />
                ...
                <form onSubmit={this.handleScoreSubmit}>
                    <div className="row">
                        ...
                        <div className="three columns">
                            ...
                            <input
                                ...
                                className="u-full-width"
                                name="min"
                                value={this.state.score.min}
                                placeholder="Enter a Min Score"
                                onChange={this.onScoreChange}
                            />
                        </div>
                        <div className="three columns">
                    ...
                    <div className="row">
                        <button
                            ...
                            disabled={this.state.score.status === "0"}
                        >
                            Submit Score
                        </button>
                    </div>
